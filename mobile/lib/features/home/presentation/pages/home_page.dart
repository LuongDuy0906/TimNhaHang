...
import 'package:mobile/features/home/domain/usecase/get_all_restaurant.dart';
// Giả định: Bạn cần import UseCase tìm kiếm
import 'package:mobile/features/home/domain/usecase/search_restaurant.dart';
import 'package:mobile/features/home/domain/usecase/update_restaurant.dart';
import 'package:mobile/features/home/presentation/widgets/home/customer_appBar_homepages.dart';
import 'package:mobile/features/home/presentation/pages/detail_restaurant.dart';
import 'package:mobile/features/home/presentation/widgets/home/empty_result.dart';
import 'package:mobile/features/home/presentation/widgets/home/restaurant_gridview.dart';
import 'package:mobile/features/home/presentation/widgets/home/restaurant_not_found.dart';
import 'package:mobile/features/home/presentation/widgets/home/srearch_result_list.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  late final _remote = RestaurantsRemoteDataSourceImpl(apiClient: _apiClient);
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Lỗi mạng: ${e.message}')));
      }
    } on ServerException catch (e) {
      // Bắt lỗi server cụ thể
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Lỗi máy chủ: ${e.message}')));
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(
